...
export default function AnalyticsDashboard() {
  ...
  const { data: newAnalyticsData, isLoading: newAnalyticsLoading } =
    useGetNewAnalyticsSummary();
    ...
    <div className="space-y-6 py-2">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="grid w-full grid-cols-5 mb-1 h-auto gap-1">
          <TabsTrigger
            value="traffic"
            className="flex items-center gap-1 text-xs py-2 px-1"
          >
        ...
        <TabsContent value="reliability">
          <TechnicalReliabilitySection
            data={newAnalytics.technicalReliability}
          />
        </TabsContent>

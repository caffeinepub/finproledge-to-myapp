...
function PriorityBadge({ priority }: { priority: unknown }) {
  ...
  const config = map[priority as string] ?? {
          ...
          <div className="flex items-center justify-between">
            ...
            <Dialog open={todoDialogOpen} onOpenChange={setTodoDialogOpen}>
              ...
              <DialogContent>
                ...
                <ClientCreateToDoForm
                  onSuccess={() => setTodoDialogOpen(false)}
                />
              </DialogContent>
            </Dialog>
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            >
              ...
              <DialogContent>
                ...
                <ClientCreateTimelineForm
                  onSuccess={() => setTimelineDialogOpen(false)}
                />
              </DialogContent>
            </Dialog>
          </div>
                    ...
                    <TableRow key={String(entry.id)}>
                      ...
                      <TableCell>
                        <TimelineStatusSelect
                          timelineId={entry.id}
                          currentStatus={
                            entry.status as unknown as TimelineStatus
                          }
                        />
                      </TableCell>
                    </TableRow>
                    ...
                    <TableRow key={String(item.id)}>
                      ...
                      <TableCell>
                        <FollowUpStatusSelect
                          followUpId={item.id}
                          currentStatus={
                            item.status as unknown as FollowUpStatus
                          }
                        />
                      </TableCell>
                    </TableRow>

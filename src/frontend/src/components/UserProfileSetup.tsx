...
export default function UserProfileSetup() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Automatically queue the new user for admin approval so the admin always
      // sees every registration in the approval list.
      try {
        await requestApproval.mutateAsync();
      } catch {
        // Silently ignore — the profile was created successfully; approval request
        // is best-effort and does not block onboarding.
      }
    } catch (error: unknown) {

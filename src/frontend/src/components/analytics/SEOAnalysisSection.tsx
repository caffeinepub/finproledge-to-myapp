...
export default function SEOAnalysisSection({
  ...
  const _keywords =
    Number(seoScore.keywords) > 0 ? Number(seoScore.keywords) : 142;
  const backlinks =
    Number(seoScore.backlinks) > 0 ? Number(seoScore.backlinks) : 384;
        ...
        <Card className="border border-border shadow-sm">
          <CardContent className="pt-5 pb-4 px-5">
            ...
            <p className="text-xs text-muted-foreground mt-1">
              of impressions result in a click
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="border border-border shadow-sm">
          <CardContent className="pt-5 pb-4 px-5">
            ...
            <div className="flex items-center gap-2 mt-1">
              ...
              <Badge
                variant={
                  backlinkStatus === "Healthy" ? "default" : "destructive"
                }
                className={
                  backlinkStatus === "Healthy"

...
import type { SearchIntentMetrics } from "../../backend";
  ...
  return (
    <section className="space-y-4">
      ...
      <p className="text-sm text-muted-foreground mb-4">
        Track local search rankings, seasonal keyword spikes, and AI search
        engine visibility.
      </p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <Card className="border border-border shadow-sm">
          <CardContent className="pt-5 pb-4 px-5">
            ...
            <p className="text-xs text-muted-foreground mt-2">
              Keywords actively tracked for local search positions (e.g.,
              "Accountant near me").
            </p>
        ...
        <Card className="border border-border shadow-sm">
          <CardContent className="pt-5 pb-4 px-5">
            ...
            <p className="text-xs text-muted-foreground mt-2">
              Likelihood that AI search engines (Google SGE, Perplexity) cite
              your site as a reliable financial source.
            </p>
          </CardContent>
        </Card>
      </div>
        ...
        <CardHeader className="border-b border-border bg-muted/30 px-5 py-3">
          <CardTitle className="text-sm font-semibold text-foreground flex items-center gap-2">
            ...
            <span className="ml-2 text-xs font-normal text-muted-foreground">
              — highlighted bars = tax deadline months
            </span>
          </CardTitle>
        </CardHeader>
          ...
          <Table>
            <TableHeader>
              <TableRow className="border-b border-border bg-muted/20">
                ...
                <TableHead className="text-xs font-semibold uppercase tracking-wider text-muted-foreground py-2 px-4 text-center">
                  Position
                </TableHead>
                <TableHead className="text-xs font-semibold uppercase tracking-wider text-muted-foreground py-2 px-4 text-center">
                  Trend
            ...
            <TableBody>
              {LOCAL_SEO_KEYWORDS.map((kw, idx) => (
                ...
                >
                  <TableCell className="py-2.5 px-4 text-sm text-foreground">
                    {kw.keyword}
                  </TableCell>
                  <TableCell className="py-2.5 px-4 text-center">
                    <span
                      className={`inline-flex items-center justify-center w-8 h-8 rounded-full text-sm font-bold ${kw.position <= 5 ? "bg-emerald-100 text-emerald-800" : kw.position <= 10 ? "bg-amber-100 text-amber-800" : "bg-muted text-muted-foreground"}`}
                    >
                      {kw.position}
                    </span>
                  </TableCell>

...
import { FollowUpStatus, TimelineStatus, ToDoStatus } from "../backend";
import {
...
export function ToDoStatusSelect({
  ...
  const [optimisticStatus, setOptimisticStatus] =
    useState<ToDoStatus>(currentStatus);
...
export function TimelineStatusSelect({
  timelineId,
  currentStatus,
}: TimelineStatusSelectProps) {
  const [optimisticStatus, setOptimisticStatus] =
    useState<TimelineStatus>(currentStatus);
...
export function FollowUpStatusSelect({
  ...
  const [optimisticStatus, setOptimisticStatus] =
    useState<FollowUpStatus>(currentStatus);

        ...
        <div className="mb-5 flex items-start gap-3 bg-blue-50 border border-blue-200 rounded-lg p-4">
          ...
          <div>
            ...
            <p className="text-xs text-blue-700 mt-0.5">
              All client payments will be directed to this PayPal account. Make
              sure this email is linked to an active PayPal business account.
              This information is <strong>only visible to you</strong> as the
              administrator.
            </p>
          </div>
        </div>
        ...
        {success && (
          <Alert className="mb-4 border-emerald-200 bg-emerald-50">
            ...
            <AlertDescription className="text-emerald-800 text-sm">
              Payment settings saved successfully. PayPal account:{" "}
        ...
        {isLoading ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              >
                PayPal Receiving Email Address{" "}
                <span className="text-red-500">*</span>
              </Label>
              <p className="text-xs text-muted-foreground">
                Enter the email address associated with your PayPal account
                where you want to receive client payments.
              </p>

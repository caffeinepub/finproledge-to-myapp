...
export default function ClientCreateFollowUpForm({
  onSuccess,
}: ClientCreateFollowUpFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const msg =
        err instanceof Error ? err.message : "Failed to create follow-up item.";
      setError(msg);
    }
  };
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="flex justify-end gap-3 pt-2">
        ...
        <Button type="submit" disabled={createClientFollowUp.isPending}>
          {createClientFollowUp.isPending && (

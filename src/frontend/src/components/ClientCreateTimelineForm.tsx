...
export default function ClientCreateTimelineForm({
  onSuccess,
}: ClientCreateTimelineFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const msg =
        err instanceof Error ? err.message : "Failed to create timeline entry.";
      setError(msg);
    }
  };
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="space-y-1.5">
        ...
        >
          ...
          <SelectContent>
            ...
            <SelectItem value={TimelineStatus.inProgress}>
              In Progress
            </SelectItem>
      ...
      <div className="flex justify-end gap-3 pt-2">
        ...
        <Button type="submit" disabled={createClientTimeline.isPending}>
          {createClientTimeline.isPending && (

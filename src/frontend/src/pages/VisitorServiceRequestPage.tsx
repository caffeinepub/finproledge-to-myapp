...
import { useCreateVisitorRequestWithLead } from "../hooks/useServiceRequests";
...
export default function VisitorServiceRequestPage() {
  ...
  const createVisitorRequestWithLead = useCreateVisitorRequestWithLead();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    // Required: name (fullName), company (businessName), phone, serviceType
    if (
      !formData.name ||
      !formData.company ||
      !formData.phone ||
    ...
    try {
      ...
      await createVisitorRequestWithLead.mutateAsync({
      ...
      <section className="bg-navy py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-white/60 max-w-2xl mx-auto">
            Reach out to our team of financial experts. We're here to help you
            navigate your financial needs with precision and care.
          </p>
        </div>
      </section>
              ...
              <Card className="border-border">
                <CardContent className="p-6 md:p-8">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          required
                          data-ocid="service-request.name.input"
                        />
                      </div>
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          required
                          data-ocid="service-request.company.input"
                        />
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          required
                          data-ocid="service-request.phone.input"
                        />
                      </div>
                      <div className="space-y-2">
                        <Label htmlFor="email">
                        ...
                        <Input
                          ...
                          data-ocid="service-request.email.input"
                        />
                      </div>
                    </div>
                    ...
                    <Button
                      type="submit"
                      disabled={createVisitorRequestWithLead.isPending}
                      className="w-full bg-gold hover:bg-gold/90 text-navy font-semibold"
                      size="lg"
                      data-ocid="service-request.submit_button"
                    >
                      {createVisitorRequestWithLead.isPending ? (

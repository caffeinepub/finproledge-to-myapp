        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground text-lg">
              Request our technical financial execution services. We'll review
              your requirements and get back to you promptly.
            </p>
          </div>
            ...
            <div className="lg:col-span-2">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Fill out the form below to request a service. Our team will
            ...
            <div className="space-y-6">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex gap-3">
                    ...
                    <div className="text-sm">
                      ...
                      <div className="text-muted-foreground">
                        We begin work with our zero-error protocol
                      </div>
                    </div>
                  </div>
                </CardContent>
              ...
              <Card className="bg-accent">
                ...
                <CardContent className="text-sm text-muted-foreground">
                  Every deliverable follows our Four-Eyes Review protocol and is
                  completed at least 5 days before your deadline.
                </CardContent>
              </Card>
            </div>
          </div>

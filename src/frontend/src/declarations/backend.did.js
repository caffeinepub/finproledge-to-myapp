...
export const LeadRequestInput = IDL.Record({
  'serviceType' : ServiceType,
...
export const idlService = IDL.Service({
  ...
  'createVisitorRequestWithLead' : IDL.Func([LeadRequestInput], [IDL.Nat], []),
  ...
  'isAnyUser' : IDL.Func([], [IDL.Bool], ['query']),
...
export const idlFactory = ({ IDL }) => {
  ...
  const LeadRequestInput = IDL.Record({
    'serviceType' : ServiceType,
    'businessName' : IDL.Text,
    'fullName' : IDL.Text,
    'description' : IDL.Text,
  ...
  return IDL.Service({
    ...
    'createVisitorRequest' : IDL.Func([ServiceRequestInput], [IDL.Nat], []),
    'createVisitorRequestWithLead' : IDL.Func(
        [LeadRequestInput],
        [IDL.Nat],
        [],
      ),
